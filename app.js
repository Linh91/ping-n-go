...
app.post('/results', urlencodedParser, function (req, res) {
  ...
  var e1_id = e1_id.intBetween(66, 99);
  ...
  var e2_id = e2_id.intBetween(33, 66);
  ...
  var e3_id = e3_id.intBetween(100, 130);
  ...
  var e4_id = e4_id.intBetween(10, 33);
  ...
  var e5_id = e5_id.intBetween(0, 9);
